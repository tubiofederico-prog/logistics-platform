...
export function Topbar() {
  return (
    <header className="h-16 bg-dark-secondary border-b border-dark-border fixed top-0 right-0 left-64 z-40">
      <div className="h-full px-6 flex items-center justify-between">
        <div className="flex items-center gap-4 flex-1">
          <div className="relative hidden md:block w-80">
            ...
            <input
              ...
              className="w-full bg-dark-tertiary border border-dark-border rounded-lg pl-10 pr-4 py-2.5 text-sm text-gray-300 placeholder-gray-500 focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="relative p-2 hover:bg-dark-tertiary rounded-lg transition-colors">
